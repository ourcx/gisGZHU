...
function point (lonLat, source, map, name, text = '', label = 'label') {
  const ControlStore = useContorlStore()
  const img = document.createElement('img')
  img.className = 'label-img' + name

  const targetItem = ControlStore.list.find(item => item.name === name)
  img.style.display = 'none' // 默认隐藏

  if (targetItem) {
    img.src = targetItem.img
  ...
  labelEl.style.backdropFilter = 'blur(30px)'
  labelEl.textContent = name
  labelEl.appendChild(document.createElement('br'))
...
function removePoint (source, map, labelName = '.label') {
...
function startPoint (source, map) {
  point(
    [113.26589283054267, 23.14849477003483],
    source,
    map,
    '5号楼',
    '桂花岗图书馆和日常上课的地方,图书馆/教室'
  )
  point(
    [113.2659751816075, 23.147520767568835],
    source,
    map,
    '南D',
    '本科生宿舍'
  ...
  point(
    [113.26557276599142, 23.14806123950214],
    source,
    map,
    '饭堂',
    '三层饭堂,再上面是宿舍'
  ...
  point(
    [113.26495656313652, 23.148553273520818],
    source,
    map,
    '足球场',
    '校园跑和军训地点'
  ...
  point(
    [113.26530336943097, 23.149484825277113],
    source,
    map,
    '1号楼',
    '教务处,平时领东西和找辅导员'
  ...
  point(
    [113.26553123944764, 23.150068602834523],
    source,
    map,
    '乒乓球室',
    '在北区,楼里面,从外面进去,里面是乒乓球室和舞蹈室'
  )
  point(
    [113.26560404516607, 23.150609007703792],
    source,
    map,
    '11号楼',
    '有些课在这里上'
  ...
  point(
    [113.26621245406143, 23.147954951046756],
    source,
    map,
    '9号楼',
    '不可言语的场所，少年'
  ...
  point(
    [113.26602492351883, 23.15111568909228],
    source,
    map,
    '研究生宿舍',
    '宿舍'
  ...
  point(
    [113.26721412897234, 23.148389142303813],
    source,
    map,
    '后山',
    '篮球场,网球馆,后山很大,走楼梯上去'
  ...
  point(
    [113.26651839597568, 23.149694464042085],
    source,
    map,
    '铁路',
    '未知的远方'
  ...
  point(
    [113.26538879979307, 23.149981346515858],
    source,
    map,
    '北区学术交流中心',
    '此处二楼是作废弃处理'
